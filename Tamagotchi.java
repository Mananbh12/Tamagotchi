...
public interface Tamagotchi
{
    ...
    /**
     * Retourne la valeur de toillete du Tamagotchi.
     * @return L'hygene.
     */
    public int getToillete();
    
    /**
     * Modifie la valeur de toillete du Tamagotchi.
     * @param hy La nouvelle valeur de toillete du Tamagotchi.
     */
    public void setToillete(int to);
