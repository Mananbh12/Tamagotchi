...
public class Environment extends Applet{
    ...
    private final String[] salle_de_bain={"Salle de bain", "Chambre", "Toilette"};
    private final String[] toillete={"Toilette", "Salle de bain"};
    ...
    public void updateList(String s){
        switch(s){
            ...
            case "Salle de bain":
                ...
                break;
            case "Toilette":
                this.emplacements = new JComboBox(toillete);
                break;
        }
    }
